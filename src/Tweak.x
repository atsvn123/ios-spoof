    ...
    return [NSString stringWithFormat:
        @"(()=>{"
         ...
         "patchGL(window.WebGLRenderingContext&&WebGLRenderingContext.prototype);patchGL(window.WebGL2RenderingContext&&WebGL2RenderingContext.prototype);"
          ...
          "const patchRTCGlobal=(n)=>{const Native=window[n];if(!Native||Native.__iosspoof_ctor)return;patchRTCProto(Native);const Fake=function(cfg,...rest){try{cfg=Object.assign({},cfg||{});cfg.iceServers=[];}catch(e){}return new Native(cfg,...rest);};try{Object.setPrototypeOf(Fake,Native);Fake.prototype=Native.prototype;Object.defineProperty(Fake,'__iosspoof_ctor',{value:1});window[n]=Fake;maskNative(window[n],n);}catch(e){}};patchRTCGlobal('RTCPeerConnection');patchRTCGlobal('webkitRTCPeerConnection');"
